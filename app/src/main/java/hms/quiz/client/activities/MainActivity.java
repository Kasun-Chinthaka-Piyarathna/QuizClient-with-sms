...
import hms.quiz.client.fragments.SlideFragment;
...
public class MainActivity extends FragmentActivity {
     ...
     */
    private static final int NUM_PAGES = 6;//100
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Instantiate activity_play_radio_button_selected_state ViewPager and activity_play_radio_button_selected_state PagerAdapter.
        mPager = findViewById(R.id.pager); //the UI pager
